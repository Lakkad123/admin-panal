...
import { viewInternshipByCompany } from '../../store/action/getData'
import Nav from '../nav/Nav'
const InternShipCompany = ({ res, dispatch }) => {
    ...
    useEffect(() => {
        dispatch(viewInternshipByCompany(id))
    }, [])
    ...
    useEffect(()=>{
        const result =  data && data.filter(item=>{
            return item.technology.toLowerCase().match(search.toLowerCase());
        })
        setFilter(result);
    },[search])
...
const mapStateToProps = (state) => (
    {
        res: state.viewInternshipByCompany
    }
)
export default connect(mapStateToProps)(InternShipCompany)