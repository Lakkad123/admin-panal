...
import { userAppliedJobList } from '../../store/action/getData'

const JobUser = ({ dispatch, res }) => {
    ...
    useEffect(() => {
        dispatch(userAppliedJobList(id))
    }, []);
...
const mapStateToProps = (state) => ({
    res: state.userAppliedJobList
})

export default connect(mapStateToProps)(JobUser)